...
const elfConfig = require('isit-code-pennock').elfConfig;
const elfUtils = require('isit-code-pennock').elfUtils;
// const elfLog = require('isit-code-pennock').elfLog('config-settings');
